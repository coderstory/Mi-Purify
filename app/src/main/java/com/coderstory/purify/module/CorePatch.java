...
public class CorePatch extends XposedHelper implements IModule {
    ...
    public void initZygote(IXposedHookZygoteInit.StartupParam paramStartupParam) {
        ...
        final Class packageClazz = findClass("android.content.pm.PackageParser.Package", null);
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        if (("android".equals(loadPackageParam.packageName)) && (loadPackageParam.processName.equals("android"))) {
            ...
            Class packageClazz = findClass("android.content.pm.PackageParser.Package", loadPackageParam.classLoader);
            Class signingDetails = findClass("android.content.pm.PackageParser.SigningDetails", loadPackageParam.classLoader);
            ...
            Class packageParserException = findClass("android.content.pm.PackageParser.PackageParserException", loadPackageParam.classLoader);
            ...
            hookAllMethods("android.util.apk.ApkSignatureVerifier", loadPackageParam.classLoader, "compareSignatures", new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam methodHookParam) throws Throwable {
                    super.beforeHookedMethod(methodHookParam);
                    if (prefs.getBoolean("comparisonSignature", false) && CorePatch.this.signatures != null) {
