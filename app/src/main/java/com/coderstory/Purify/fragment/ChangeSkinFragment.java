...
public class ChangeSkinFragment extends BaseFragment {
    ...
    private static String SKIN_PINK_NAME = "skin_pink.skin";
    ...
    protected void setUpView() {
        ...
        $(R.id.ll_brown).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String skinFullName = SKIN_DIR + File.separator + SKIN_BROWN_NAME;
                FileUtils.moveRawToDir(getMContext(), SKIN_BROWN_NAME, skinFullName);
        ...
        $(R.id.ll_black).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String skinFullName = SKIN_DIR + File.separator + SKIN_BLACK_NAME;
                FileUtils.moveRawToDir(getMContext(), SKIN_BLACK_NAME, skinFullName);
                File skin = new File(skinFullName);
                if (!skin.exists()) {
                    Toast.makeText(getMContext(), "请检查" + skinFullName + "是否存在", Toast.LENGTH_SHORT).show();
                    return;
        ...
        $(R.id.ll_pink).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String skinFullName = SKIN_DIR + File.separator + SKIN_PINK_NAME;
                FileUtils.moveRawToDir(getMContext(), SKIN_PINK_NAME, skinFullName);
                File skin = new File(skinFullName);
                if (!skin.exists()) {
                    Toast.makeText(getMContext(), "请检查" + skinFullName + "是否存在", Toast.LENGTH_SHORT).show();
                    return;
